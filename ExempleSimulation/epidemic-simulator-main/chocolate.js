...
var motionCounter = 1,
    ...
    infectionRecord = [],
    distanceRecord = [],
    intercityPopulation = 0,
    quarantineCounter = -140,
    currentcentral = 0,
    gameSettings = 96,
    finalScore = 0;
...
function gameMode() {
    if (gamemode == 0) {
        gamemode++;
        if (localStorage.getItem("highscore") > 0) {} else { localStorage.setItem("highscore", 0) }
        gameSettingsTracker();
    } else { gamemode = 0; }
}
...
function motion() {
    ...
    for (var i = 0; i < particlePositionX.length; i++) {
        if (particleSIR[i] == 0) { cMotion.fillStyle = "#60E4F0" } else if (particleSIR[i] == 1) { cMotion.fillStyle = "#EC4444" } else if (particleSIR[i] == 2) { cMotion.fillStyle = "#6D6D6D" } else if (particleSIR[i] == 3 && patientIsolation == 1) { cMotion.fillStyle = "#D6EA50" } else if (particleSIR[i] == 3 && patientIsolation == 0) { cMotion.fillStyle = "#EC4444" } else if (particleSIR[i] == 4) { cMotion.fillStyle = "#EC4444" }
        ...
        if (citysetting == 0) {
            ...
            if (particleIsolation[i] == 0) {
                if (particlePositionX[i] < 20) { particleMotionX[i] += (particlePositionX[i] - 5) / -7.5 + 2 } else if (particlePositionX[i] > 630) { particleMotionX[i] -= (particlePositionX[i] - 630) / 7.5 } else { particleMotionX[i] += Math.random() - 0.5 }
                if (particlePositionY[i] < 20) { particleMotionY[i] += (particlePositionY[i] - 5) / -7.5 + 2 } else if (particlePositionY[i] > 630) { particleMotionY[i] -= (particlePositionY[i] - 630) / 7.5 } else { particleMotionY[i] += Math.random() - 0.5 }
            }
            if (particleIsolation[i] == 1) {
                if (particlePositionX[i] < 680) { particleMotionX[i] += (particlePositionX[i] - 665) / -7.5 + 2 } else if (particlePositionX[i] > 860) { particleMotionX[i] -= (particlePositionX[i] - 860) / 7.5 } else { particleMotionX[i] += Math.random() - 0.5 }
                if (particlePositionY[i] < 450) { particleMotionY[i] += (particlePositionY[i] - 435) / -7.5 + 2 } else if (particlePositionY[i] > 630) { particleMotionY[i] -= (particlePositionY[i] - 630) / 7.5 } else { particleMotionY[i] += Math.random() - 0.5 }
            }
        ...
        if (citysetting == 1 && particleInterCity[i] == 0) {
            if (particleCentralLocation[i] == 0 && particleIsolation[i] == 0) {
                ...
                if (socialDistance == 1) {
                    ...
                    if (counterX[particleCityX[i] + 3 * particleCityY[i]] / counter[particleCityX[i] + 3 * particleCityY[i]] > particlePositionX[i] / 210) { particleMotionX[i] += Math.random() * 5 } else { particleMotionX[i] -= Math.random() * 3 }
                    if (counterY[particleCityX[i] + 3 * particleCityY[i]] / counter[particleCityX[i] + 3 * particleCityY[i]] > particlePositionY[i] / 210) { particleMotionY[i] += Math.random() * 5 } else { particleMotionY[i] -= Math.random() * 3 }
                }
            ...
            if (particleIsolation[i] == 0 && particleCentralLocation[i] == 0) {
                if (particlePositionX[i] < 20) { particleMotionX[i] += (particlePositionX[i] - 5) / -7.5 + 2 } else if (particlePositionX[i] > 190) { particleMotionX[i] -= (particlePositionX[i] - 190) / 7.5 } else { particleMotionX[i] += Math.random() - 0.5 }
                if (particlePositionY[i] < 20) { particleMotionY[i] += (particlePositionY[i] - 5) / -7.5 + 2 } else if (particlePositionY[i] > 190) { particleMotionY[i] -= (particlePositionY[i] - 190) / 7.5 } else { particleMotionY[i] += Math.random() - 0.5 }
            }
            if (particleIsolation[i] == 1) {
                if (particlePositionX[i] < 680) { particleMotionX[i] += (particlePositionX[i] - 665) / -7.5 + 2 } else if (particlePositionX[i] > 860) { particleMotionX[i] -= (particlePositionX[i] - 860) / 7.5 } else { particleMotionX[i] += Math.random() - 0.5 }
                if (particlePositionY[i] < 450) { particleMotionY[i] += (particlePositionY[i] - 435) / -7.5 + 2 } else if (particlePositionY[i] > 630) { particleMotionY[i] -= (particlePositionY[i] - 630) / 7.5 } else { particleMotionY[i] += Math.random() - 0.5 }
            ...
            for (j = 0; j < particlePositionX.length; j++) {
                if (particleSIR[j] == 0 && citysetting == 0) {
                    if (Math.pow(particlePositionX[i] - particlePositionX[j], 2) + Math.pow(particlePositionY[i] - particlePositionY[j], 2) < Math.pow(infectionRadius, 2) && Math.random() < 1 - Math.pow(1 - infectionP, 0.2)) {
                        if (Math.random() < document.getElementById("asymptomatic").value / 10) {
                            particleSIR[j] = 3;
